--[[
    ...
    - Added source type to the love.audio.newSource function (i.e. 'static' or 'stream')
      for documentation when to use either of them, see: https://love2d.org/wiki/Tutorial:Audio
    - Updated love.filesystem.exists to love.filesystem.getInfo
]]
...
function loadHighScores()
    ...
    -- Old version: love.filesystem.exists, LÖVE v11: love.filesystem.getInfo
